...
public class AthleteStat {
    ...
    public static class Mapper1 extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
        ...
        public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
            ...
            String id = csvLine[0];
            String sex = csvLine[2];
            String noc = csvLine[7];
            if ("\"ID\"".equals(id))
                return;
    ...
    public static class Reducer1 extends MapReduceBase implements Reducer<Text, Text, Text, IntWritable> {
        public void reduce(Text key, Iterator<Text> values, OutputCollector<Text, IntWritable> output, Reporter reporter) throws IOException {
            int sum = 0;
            String formerId = "";
            String id = "";
            while (values.hasNext()) {
                id = String.valueOf(values.next());
                if (formerId.equals(id)) {
                    continue;
                }
                formerId = id;
                ++sum;
    ...
    public static void main(String[] args) throws Exception {
        // job1，负责count
        JobConf job1 = new JobConf(AthleteStat.class);
        ...
        job1.setMapperClass(AthleteStat.Mapper1.class);
//        job1.setCombinerClass(AthleteStat.Reducer1.class);
        job1.setReducerClass(AthleteStat.Reducer1.class);
        ...
        // job2，负责sort
        JobConf job2 = new JobConf(AthleteStat.class);
        ...
        job2.setMapperClass(AthleteStat.Mapper2.class);
//        job2.setCombinerClass(Test2.Reducer2.class);
        job2.setReducerClass(AthleteStat.Reducer2.class);
